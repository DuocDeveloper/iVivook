...
class Autor(models.Model):
    ...
    defuncion = models.DateField(
        verbose_name="Fecha Defunción", null=True, blank=True)
...
class Libro(models.Model):
    CATEGORIAS = [('1', 'Romance'), ('2', 'Acción'),
                  ('3', 'Aventura'), ('4', 'Comedia')]
    titulo = models.CharField(verbose_name="Titulo", max_length=250)
    autor = models.ForeignKey(
        Autor, on_delete=models.DO_NOTHING, verbose_name="Autor")
    ...
    categoria = models.CharField(
        verbose_name="Categoría", choices=CATEGORIAS, max_length=1)
